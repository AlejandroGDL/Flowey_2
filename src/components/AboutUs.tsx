    ...
    return(
        <div className="Container_AboutUs">
            <div className="Header_AboutUs">
                ...
                <div>
                    <img src="../src/assets/Photos/OurPhoto2.jpg" alt="Nosotros 1"  id="Photo"/>
                    <img src="../src/assets/Photos/OurPhoto3.jpg" alt="Nosotros 2" id="Photo"/>
                    <img src="../src/assets/Photos/OurPhoto4.jpg" alt="Nosotros 3" id="Photo"/>
                    <img src="../src/assets/Photos/OurPhoto5.jpg" alt="Nosotros 4" id="Photo"/>
                    <img src="../src/assets/Photos/OurPhoto1.jpg" alt="Nosotros 5" id="Photo"/>
                </div>
            </div>
