                ...
                <form onSubmit={store} className='Form_Register'>
                    <div className='Container_Form'>
                        <div className='Inputs_R'>
                            <div>
                                <TextField value={Nombre} onChange={(e)=>setNombre(e.target.value)} type='Text' className='Text_R' label="Nombre" variant="filled" margin="none"/>
                            </div>
                        
                            <div>
                                <TextField value={Apellidos} onChange={(e)=>setApellidos(e.target.value)} type='Text' className='Text_R' label="Apellidos" variant="filled" margin="none"/>
                            </div>
                        
                            <div>
                                <TextField value={Correo} onChange={(e)=>setCorreo(e.target.value)} type='Email' className='Text_R' label="Correo Electronico" variant="filled" margin="none"/>
                            </div>
                        
                            <div>
                                <TextField value={Contraseña} onChange={(e)=>setContraseña(e.target.value)} type='password' className='Text_R' label="Contraseña" variant="filled" margin="none"/>
                            </div>
                            
                        </div>
                        <div className='Datos_R'>
                            <img src={LogoFlowey} alt="Logotipo Flowey" />
