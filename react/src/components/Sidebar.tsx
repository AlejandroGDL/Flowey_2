...
function Sidebar(){
    ...
    return(
        <div className="Container_S">
            <div>
                <div className='Container_M_I'><img src={LogoFlowey} alt="Logo Sidebar" /></div>
                <div>
                    <ul className='Op_M'>
                        <li>
            ...
            <div className='Contenedor_Avatar'>
                ...
                <Button onClick={handleClick} 
                        ...
                        sx={{ fontSize: 40 }} />} >Alejandro</Button>
                {/* Menú Exandible */}
                <Menu
                    id="basic-menu"
                    anchorEl={anchorEl}
                    ...
                    <Link to={"/"}><MenuItem onClick={logout}>Cerrar Sesión</MenuItem></Link>
                </Menu>
